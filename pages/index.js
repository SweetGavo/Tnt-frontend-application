        ...
        <>
            ...
            <section className={`${Style.servicesSection}`}>
                <div className={`container flex flex-wrap`}>
                    <div className={`col-md-6 flex content-center column ${Style.textContainer}`}>
                        ...
                        <p className={`black`} style={{lineHeight: '30px'}}>T and T Markets Limited resale of metal
                            scrap materials,used
                            company items like Generators, Furniture, Electrical equipment,
                            machineries and heavy equipment.
                        </p>
                        <Link href={"/products"}>
                            <Button className={`shopNowButton ${Style.button}`} style={'blue'} size={'large'}
                                    radius={5}>Shop Now
                                <Icon path={mdiArrowRight} className={'icon'}/>
                            </Button>
                        </Link>
            ...
            <section className={Style.testimonials}>
                <div className={`container flex flex-wrap`}>
                    <div className={`col-md-12 ${Style.top}`}>
                        <h3>Testimonials</h3>
                        <p>Feedbacks are the backbone of a business. We listen to our customers, you should do
                            likewise</p>
                    </div>
                    ...
                    <div className={`flex flex-wrap col-md-12 ${Style.content}`}>
                        ...
                        <div className={`col-md-6 col-sm-12`}>
                            <div className={`${Style.testimony}`}>
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum neque fermentum
                                    suscipit arcu enim
                                    vestibulum, donec.</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum neque fermentum
                                    suscipit arcu enim
